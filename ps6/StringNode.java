...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode pointer = str.next;
        

        while (pointer != null) {
            StringNode nextNode = new StringNode(pointer.ch, null);
                                         ...
                                         char afterChar) 
    {
        if (str == null) {
            ...
            StringNode strRest = insertAfter(str.next, newChar, afterChar);
            str.next = strRest;
        }
    ...
    public static StringNode removeAllSpaces(StringNode str) {
        ...
        StringNode head = str; // the start of the linked list
        StringNode prevNode = null; // the previous assigned to the head and then gets traversed
    ...
    public static void main(String[] args) {
        ...
        // remove spaces tester
        StringNode anotherString = StringNode.convert("hi my name is ");
        System.out.println(removeAllSpaces(anotherString));

        // my own copy tester
        StringNode myOwnString = StringNode.convert("previous");
        System.out.println("this is a copy: " + copy(myOwnString));
