 ...
 */
 ...
 public class LinkedTree {
     ...
     private class PostorderIterator implements LinkedTreeIterator {
         ...
         // overrides the LinkedTree hasNext()
         public boolean hasNext() {
         ...
         public int next() {
            ...
            while (nextNode != null || !stack.isEmpty()) {
                if (!stack.isEmpty()) {
                    ...
                    if (parent.right == null || parent.right == nextNode) {
                        nextNode = stack.pop();
                        break;
                    } else {
                        nextNode = parent.right;
     ...
     public static void main(String[] args) {
         ...
         LinkedTree testTree = new LinkedTree();
         testTree.insert(45, "A");
         testTree.insert(50, "B");
         testTree.insert(34, "C");
         testTree.insert(35, "D");
         testTree.insert(23, "E");
         testTree.insert(12, "F");
         testTree.insert(18, "G");
 
         LinkedTreeIterator testIterator = testTree.postorderIterator();
         while (testIterator.hasNext()) {
             int key = testIterator.next();
